...
<%
	...
	Student s = new Student(1000,"천한생",new Car(1234,"AVANTE","WHITE"));


	Guest g = new Guest(100,"백백백","2022-08-16","guest100@gmail.com","http://www.100.co.kr","오늘은 EL을 공부합니다","생각보단 쉽네요....");
...
<body>
<h1>EL Bean객체의 property(멤버변수)출력</h1><hr/>
<ul>
	<li>{c}</li>
	<li>${car}</li>
