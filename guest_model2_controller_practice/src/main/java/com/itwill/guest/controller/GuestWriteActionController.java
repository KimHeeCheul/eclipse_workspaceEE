...
public class GuestWriteActionController implements Controller {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse response) {
		/*
		 * 1.GET방식이면 user_main.do로 redirection ㅡ 2.파라메타받기 ㅡ 3.GuestService객체사용해서 쓰기 ㅡ
		...
		try {
			if (request.getMethod().equalsIgnoreCase("GET")) {
				...
				Guest insertGuest = new Guest(0, guest_name, "", guest_email, guest_homepage, guest_title, guest_content);
