...
<%
	...
	*/
	 ...
	 *  yyy|2222
	 */
	boolean isMember1 = id.equals("xxx") && password.equals("1111");
	boolean isMember2 = id.equals("yyy") && password.equals("2222");
	...
	out.println("<a href='index.jsp'>메인으로</a>"); //<< " 더블을 두개 사용할시 |를 사용해야하기 때문에 ' 싱글을 사용한다
