...
<%
	...
	if(!(isMember1||isMember2)){
		//로그인 실패(실패시 Script데이타는 뿌릴 수 있다)
		out.println("<script>");
		out.println("alert('저만의 정보라 당신은 로그인 하실수 없습니다');");
		out.println("location.href='7-2.default_session_login_action.jsp';");
		out.println("</script>");
		return;
	} 
		//로그인 성공시 세션객체에 loginId라는 key값으로 아이디 값을 저장한다
