...
public class HttpServletRequestServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 ****************************/
		//클라이언트요청URL ==> http://localhost/servletSite/request.do?name=kim&phone=1234&address=seoul
		...
		System.out.println("addresss 파라메타 값"+address);
		System.out.println("******************************************************************");
		
		out.println("<h1>HttpServletRequest객체</h1><hr>");
		out.println("<ol>");
		out.println("<li>요청 메쏘드 : "+method+"</li>");
