...
public class PropertiesFileLoadMain {
	...
	public static void main(String[] args) throws Exception{
		...
		/*
		FileInputStream fis=
				new FileInputStream("C:\\KHC\\JAVA-DEVELOPER\\eclipse_workspaceEE\\user_model1\\src\\main\\java\\com\\itwill\\user\\jdbc.properties");
		properties.load(fis);
		*/
		
		properties.load(UserDao.class.getResourceAsStream("jdbc.properties"));
		System.out.println(properties);
		System.out.println(properties.getProperty("driverClassName")); //←키값
